  ...
  return [
    {
      title: 'My Network',
      items: [
        { to: '/account', label: 'Feed', sub: 'Latest from your creators', icon: 'feed', end: true },
        { to: '/account/discover', label: 'Discover', sub: 'Find new creators', icon: 'compass' },
        { to: '/account/events', label: "Today's Events", sub: 'Picks for tonight', icon: 'calendar' },
      ],
    },
    {
      title: 'Track',
      items: [
        ...
        { to: '/account/saved', label: 'Saved', sub: 'Picks & creators bookmarked', icon: 'bookmark' },
        { to: '/account/subscriptions', label: 'Subscriptions', sub: 'Manage active plans', icon: 'card' },
      ],
    },
    {
      title: 'Account',
      items: [
        { to: '/account/notifications', label: 'Notifications', sub: 'Pick alerts & billing', icon: 'bell', badge: unreadLabel },
